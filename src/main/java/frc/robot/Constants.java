...
public final class Constants {
    ...
    public final static class Setup {
        ...
        public static final double[] angleOffsets = new double[] {-96.08, 0.00, 0.00, 0.115};
    ...
    public final static class Swerve {
        ...
        public static final double trackWidth = Units.inchesToMeters(14.50);
        public static final double trackLength = Units.inchesToMeters(14.50);
